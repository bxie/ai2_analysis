...
% affiliations
\author{\IEEEauthorblockN{Benjamin Xie, Hal Abelson, and Isra Shabir}
\IEEEauthorblockA{Department of Electrical Engineering and Computer Science\\
Massachusetts Institute of Technology\\
Cambridge, Massachusetts, USA\\
Email: \{bxie, hal, ishabir \}@mit.edu}}
%\and
...
\bibitem{naming:turbak}
F.  Turbak, D.  Wolber and P.  Medlock-Walton, \emph{The design of naming features in App Inventor 2}, 2014 IEEE Symposium on Visual Languages and Human-Centric Computing (VL/HCC), 2014.

\bibitem{ai_usage}
Appinventor.mit.edu, \emph{MIT App Inventor usage for 2104}, 2015. [Online]. Available:  http://appinventor.mit.edu/explore/blogs/hal/2015/02/app-0.html. [Accessed: 03- Mar- 2015].

\bibitem{thinking:turbak}
F.  Turbak, \emph{Mobile Computational Thinking in AppInventor 2}, 2014. [Online]. Available: http://cs.wellesley.edu/~tinkerblocks/RIC14-talk.pdf. [Accessed: 06- Mar- 2015].


\bibitem{situated:hirakawa}
M. Hirakawa and K. Hewagamage, \emph{Situated Computing: A Paradigm for the Mobile User-Interaction with Multimedia Sources}, Ann. Softw. Eng., vol. 12, no. 1, pp. 213-239, 2001.

\bibitem{ai_tutorials}
Appinventor.mit.edu, \emph{Tutorials for App Inventor 2}, 2015. [Online]. Available: http://appinventor.mit.edu/explore/ai2/tutorialsd41d.html. [Accessed: 26- Mar- 2015].

\bibitem{ai_home}
Appinventor.mit.edu, \emph{MIT App Inventor}, 2015. [Online]. Available: http://appinventor.mit.edu/explore. [Accessed: 01- Mar- 2015].


\bibitem{blocks:okerlund}
J.  Okerlund and F.  Turbak, \emph{A Preliminary Analysis of App Inventor Blocks Programs}, in IEEE Symposium on Visual Languages and Human-Centric Computing, San Jose, CA, 2015.
